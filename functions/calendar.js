...
<!--获取当前日期-->
calendar.getCurrentDateTime = function() {
    var d = new Date();
...
<!-- 农历转换公历 -->
calendar.conversion = function(str) {
    /**公历年月日转农历数据 返回json
...
calendar.conversionTerm = function(year, mouth, num) {
    ...
    var day = calendar.getTerm(parseInt(year) - 2, parseInt(num) + 2);
...
<!-- 获取农历 -->
calendar.conversionLunar = function(year) {
...
<!-- 根据出生农历获取生日星座 -->
calendar.conversionAstro = function(str) {
 ...
 * @returns {any}
 */
calendar.conversionParentDate = function(year, month, weeks, nums) {
