...
let weather = {
    ...
    base_data: [ //气象类型，base:返回实况天气
        {
            city_code: 330108,//城市编码, 滨江区330108 西湖区330106 余杭区330110
            time: ['AM', 'PM'],//AM：上午, MM：中午，PM：下午
            day: [1, 2, 3, 4, 5]//周一 ~ 周五 分别对应 0~6
        }
    ],
    //周末推送未来天气
    all_data: [ //气象类型，all:返回未来4天预报天气
	    {
			...
			day: [6]//周一 ~ 周日 分别对应 0~6
        },
        {
            city_code: 330502,//城市编码, 吴兴区330502
            time: ['MM'],//AM：上午, MM：中午，PM：下午
            day: [6]//周一 ~ 周日 分别对应 0~6
        },
        {
        ...
        {
            city_code: 330108,//城市编码, 滨江区330108
            time: ['PM'],//AM：上午, MM：中午，PM：下午
            day: [0]//周一 ~ 周日 分别对应 0~6
        }
    ]
            ...
            classList: [
                {
                    type: 1, //教学方式 1:钉钉直播 2:线下教室
                    date: '2023-05-14',
                    time: '09:00 - 10:30'//课程时间
                },
                {
                    type: 1, //教学方式 1:钉钉直播 2:线下教室
                    date:'2023-05-14',
                    time: '14:00 - 15:30'//课程时间
                },
                {
                    type: 1, //教学方式 1:钉钉直播 2:线下教室
                    date: '2023-05-21',
