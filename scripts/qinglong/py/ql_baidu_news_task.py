...
def checkUpdate():
    ...
    try:
        r1 = requests.get("https://gitee.com/hosiang1026/DailyRemind/raw/master/scripts/qinglong/py/ql_baidu_news_task.py").text
        r2 = re.findall(re.compile("version = \d.\d"), r1)[0].split("=")[1].strip()
        if float(r2) > version:
            print("发现新版本：" + r2)
            print("正在自动更新脚本...")
            os.system("ql raw https://gitee.com/hosiang1026/DailyRemind/raw/master/scripts/qinglong/py/ql_baidu_news_task.py &")
    except:
        pass
...
if __name__ == '__main__':
    ...
    if load_send():
        ...
        if isinstance(content, str) and content.strip():
            ...
            print('获取今日热搜失败！', content if not isinstance(content, str) else '')
